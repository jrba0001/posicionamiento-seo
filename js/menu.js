...
var sobremiOffset = acumulativeOffset(document.getElementById("sobremi"));
var contactoOffset = acumulativeOffset(document.getElementById("contacto"));
var footerOffset = sobremiOffset + 2;
...
function changeMenuStyle(event) {
  ...
  if (pageOffset >= 0 && pageOffset < quienSoyOffset) {
    ...
    deleteActiveClass();
    setActiveItem("a[href$='#sobremi']");
  } else if (pageYOffset >= footerOffset) {
